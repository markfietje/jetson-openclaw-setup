...
fn default_webhook_retries() -> usize { 3 }
fn default_webhook_retry_delay() -> u64 { 1000 }
...
fn default_command_capacity() -> usize { 64 }
fn default_message_capacity() -> usize { 256 }
fn default_command_timeout_ms() -> u64 { 30_000 }
fn default_max_sends_per_second() -> usize { 5 }
